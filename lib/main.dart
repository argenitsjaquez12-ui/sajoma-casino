  ...
  Widget home() {
    return ListView(
      ...
      children: [
        ...
        game(Icons.style, 'Texas Holdem', 'Poker de cartas', poker),
        game(Icons.style, 'Three Card Poker', 'Poker de tres cartas', () => casinoMiniGame('THREE CARD POKER')),
        game(Icons.style, 'Caribbean Stud Poker', 'Poker contra la casa', () => casinoMiniGame('CARIBBEAN STUD')),
        game(Icons.diamond_outlined, 'Baccarat', 'Jugador, banca o empate', baccarat),
  ...
  void slots() {
    showGame('SAJOMA SLOTS', (close) {
      ...
      return StatefulBuilder(builder: (dialogContext, update) {
          ...
          return Container(
            ...
            decoration: BoxDecoration(
              gradient: const LinearGradient(
                ...
                colors: [Color(0xFFFFE8A0), Color(0xFF8A5A00), Color(0xFFFFD76A)],
              ),
            ...
            child: Container(
              ...
              child: Text(
                ...
                style: TextStyle(
                  color: value == '7' ? Colors.redAccent : Colors.black87,
                  fontSize: value.length > 5 ? 17 : 27,
                  fontWeight: FontWeight.w900,
                  letterSpacing: 1,
                ),
              ),
        ...
        Widget cabinetButton(String label, VoidCallback? action) {
          return Expanded(
            child: neonButton(label, action, color: Colors.black87),
          );
        }
          ...
          child: Column(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: const LinearGradient(
                    colors: [Color(0xFF680B0B), Color(0xFF160000), Color(0xFF680B0B)],
                  ),
                ...
                child: const Column(
                  children: [
                    Text('SAJOMA RICHES',
                        style: TextStyle(color: gold, fontSize: 27, fontWeight: FontWeight.w900, letterSpacing: 2)),
                    Text('MEGA JACKPOT',
                        style: TextStyle(color: Colors.white70, fontSize: 11, fontWeight: FontWeight.w800, letterSpacing: 3)),
                    SizedBox(height: 3),
                    Text('1,250,680',
                        style: TextStyle(color: Colors.amber, fontSize: 25, fontWeight: FontWeight.w900, letterSpacing: 2)),
                  ],
                ),
              ),
              const SizedBox(height: 10),
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: const LinearGradient(colors: [Color(0xFF151515), Color(0xFF050505)]),
                        borderRadius: BorderRadius.circular(9),
                      ...
                      child: const Column(
                        children: [
                          Text('PAYTABLE',
                              style: TextStyle(color: gold, fontSize: 13, fontWeight: FontWeight.w900)),
                          SizedBox(height: 5),
                          Text('777 = 1,000×    BAR = 500×    DIAMANTE = 250×',
                              textAlign: TextAlign.center,
                              style: TextStyle(color: Colors.white, fontSize: 11, fontWeight: FontWeight.w800)),
                          SizedBox(height: 3),
                          Text('3 IGUALES = PREMIO MÁXIMO • 2 IGUALES = 250 COINS',
                              textAlign: TextAlign.center,
              ...
              Row(
                children: [
                  cabinetButton('− 50', bet <= 100 ? null : () => update(() => bet -= 50)),
                  ...
                  Expanded(
                    child: Container(
                      ...
                      alignment: Alignment.center,
                      decoration: BoxDecoration(
                        gradient: const LinearGradient(colors: [Color(0xFF2B1A00), Color(0xFF090909)]),
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(color: gold, width: 2),
                      ),
                      child: Text('$bet COINS',
                          style: const TextStyle(color: gold, fontSize: 16, fontWeight: FontWeight.w900)),
                    ),
                  ),
                  const SizedBox(width: 7),
                  Expanded(child: neonButton('+ 50', () => update(() => bet = min(bet + 50, 5000)), color: const Color(0xFF5A3A00))),
                ],
              ),
              const SizedBox(height: 8),
              neonButton(
                ...
                busy
                    ...
                    : () {
                        ...
                        Future.delayed(const Duration(milliseconds: 700), () {
                          ...
                          final same = result[0] == result[1] && result[1] == result[2];
                          final pair = result[0] == result[1] || result[1] == result[2] || result[0] == result[2];
                          final reward = same ? bet * 10 : (pair ? 250 : -bet);
                          update(() {
                            creditsWon = reward > 0 ? reward : 0;
                            a = result[0];
                            b = result[1];
                            c = result[2];
                            busy = false;
                          });
                          move(reward, 'SAJOMA SLOTS: ${reward >= 0 ? '+' : ''}$reward',
                              win: reward > 0);
              ...
              Text(
                creditsWon > 0 ? 'PREMIO: +$creditsWon COINS' : 'MONEDAS VIRTUALES • SIN DINERO REAL',
                style: TextStyle(
                  color: creditsWon > 0 ? Colors.amber : Colors.white38,
                  fontWeight: FontWeight.w900,
                ),
              ),
            ],
  ...
  Widget miniVisual(String title) {
    ...
    if (t.contains('MINES')) {
      return Wrap(spacing: 5, runSpacing: 5, children: List.generate(25, (i) => Container(
        ...
        child: const Icon(Icons.diamond_outlined, color: Colors.cyanAccent),
      )));
    }
